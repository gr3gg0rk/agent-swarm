...
export class DependencyScheduler {
     ...
     */
    validateDependencies(taskId, dependencies, allTasks) {
     ...
     */
    hasPendingDependencies(task, allTasks) {
        if (!task.dependencies || task.dependencies.length === 0) {
            return false;
        }
     ...
     */
    hasCircularDependency(taskId, dependencies, allTasks) {
        if (dependencies.length === 0) {
            return false;
        }
 ...
 */
export function createDependencyScheduler(options) {
