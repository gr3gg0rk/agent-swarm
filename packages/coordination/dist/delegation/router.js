 ...
 */
import { DEFAULT_ROLE_HIERARCHY, DEFAULT_SCORING_WEIGHTS } from './types.js';
/**
 * Role-based task router with hierarchical fallback.
 *
...
export class TaskRouter {
    ...
    calculateLoadScore(agent) {
        ...
        const combinedLoad = cpuLoad * this.scoringWeights.cpu +
    ...
    calculatePerformanceScore(agentId) {
        ...
        const performanceScore = successRate * 100 * this.scoringWeights.successRate +
     ...
     */
    createAgentWithLoad(registration, metrics, currentTasks) {
        return {
            ...registration,
            currentTasks,
