...
export declare class TimeoutMonitor {
     ...
     */
    startTimeout(taskId: string, timeoutMs: number, retryCount: number, maxRetries: number, onTimeout: TimeoutCallback): void;
    /**
 ...
 */
export declare function calculateBackoffDelay(retryCount: number, maxDelayMs?: number, jitterMs?: number): number;
/**
 ...
 */
export declare function createTimeoutMonitor(options?: TimeoutMonitorOptions): TimeoutMonitor;
