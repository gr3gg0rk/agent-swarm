...
export class VectorClockImpl {
     ...
     */
    constructor(machineId, initialTimestamp) {
     ...
     */
    static fromJSON(json, machineId) {
        const data = json;
 ...
 */
export function createVectorClock(machineId, initialTimestamp) {
