 ...
 */
export type { CheckpointData, CheckpointMetadata, ResumeResult, CreateCheckpointOptions, CheckpointSyncStats, CheckpointManagerOptions, } from './types.js';
...
export type { CheckpointTaskStatus, TaskRef, } from './manager.js';
 ...
 * ```
 */
export declare function createCheckpointManagerWithDefaults(options: {
