 ...
 */
export function shouldUseMessagePack(payload) {
    try {
 ...
 */
export function encodeMessage(envelope) {
    const codecEnvelope = { ...envelope };
...
export function decodeMessage(buffer) {
    try {
        ...
        try {
            ...
            throw new Error(`Failed to decode message: ${error.message}. MessagePack also failed: ${msgpackError.message}`);
        }
    }
}
/**
 ...
 */
export function getMessageSize(envelope) {
