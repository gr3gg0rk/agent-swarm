...
export class ThrottledBroadcaster {
    ...
    buffer = new Map();
    broadcastInterval;
    constructor(broadcast, maxFrequencyMs = 100 // 10 updates/second
    ) {
        this.broadcast = broadcast;
        this.maxFrequencyMs = maxFrequencyMs;
 ...
 */
export function createEventRoutes(db, mqttClient) {
    const router = Router();
