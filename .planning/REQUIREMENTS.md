...
- [ ] **OPTI-03**: MQTT connection pooling reuses connections (2-4 per agent based on hardware)
- [ ] **OPTI-04**: Connection pool limits respect hardware (Pi 2B=3, Pi 5=5, Beelink=10)
...
| OPTI-03 | Phase 7 | Pending |
| OPTI-04 | Phase 7 | Pending |
